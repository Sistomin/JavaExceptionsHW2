...
//
//На входе: '0'
//На выходе: Result: Your input was - 0
class Expr {
    public static String expr(char a) throws Exception {
// Введите свое решение ниже
        String text;
        if (a == ' '){
            text = "Empty string has been input.";
            //System.out.println("Error: Empty string has been input.");
        } else {
            text = "Your input was - " + a;
            //System.out.println("Result: Your input was - " + a);
        }
        return text;
...
//ЭТАЛОННОЕ РЕШЕНИЕ ОТ geekBrains
//Cимвол `a`
//
//class Expr {
//    public static String expr(char a) throws Exception {
